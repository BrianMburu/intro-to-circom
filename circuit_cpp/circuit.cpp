...
void Mthash_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Mthash_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 19512;}

uint get_number_of_components() {return 39;}
...
ctx->componentMemory[coffset].templateName = "Mthash";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[0]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[1]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+3564;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[2]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[3]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+7104;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[4]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+8874;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[5]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+10644;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[6]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+12414;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[7]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+13300;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[8]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+14186;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[9]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+15072;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[10]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+15958;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[11]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+16844;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[12]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+17730;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[13]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+18616;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Mthash[14]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
Fr_geq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 15
while(Fr_isTrue(&expaux[0])){
Fr_geq(&expaux[0],&lvar[3],&circuitConstants[15]); // line circom 16
if(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[3])) + 0);
{
...
// load src
Fr_sub(&expaux[0],&lvar[3],&circuitConstants[15]); // line circom 20
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * ((2 * Fr_toInt(&lvar[3])) + 1)) + 9)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * ((2 * Fr_toInt(&lvar[3])) + 2)) + 9)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 0)]].templateId].defs[0].offset+0]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
Fr_sub(&expaux[0],&lvar[3],&circuitConstants[3]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_geq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 15
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "merkle_tree_component";
mySubcomponents[aux_create+i] = aux_cmp_num;
Mthash_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 19502 ;
aux_cmp_num += 38;
}
}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[17]); // line circom 42
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Mthash_3_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[17]); // line circom 42
